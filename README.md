...
│   │   └── tianocore-wiki-mcp/ # TianoCore Wiki MCP (新增)
│   │       ├── SKILL.md
│   │       ├── mcp_server.py
│   │       ├── rag_engine.py
│   │       ├── fetch_wiki.py
...
- 英文标题验证
- PatchCheck 合规验证
- **跨平台支持：Windows + Linux (Python)**

**使用：**
```bash
# Python（推荐，跨平台）
python .opencode/skills/edk2-pr-workflow/create-pr.py --issue-url "https://github.com/tianocore/edk2/issues/12766"
python .opencode/skills/edk2-pr-workflow/update-pr.py --pr-url "https://github.com/tianocore/edk2/pull/12841"
...
TianoCore EDK II 文档 MCP 服务，基于 WeKnora-style RAG。
...
# 查看统计
python .opencode/skills/tianocore-wiki-mcp/mcp_server.py --stats
```
...
# 运行TianoCore Wiki MCP测试
python .opencode/skills/tianocore-wiki-mcp/tests/test_rag_engine.py
```
